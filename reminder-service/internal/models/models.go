...
type RabbitMQMessage struct {
	...
	ChatID     string    `json:"chat_id"`     // ID чата для отправки уведомления (MAX Messenger)
...
type CreateNotificationRequest struct {
	...
	ChatID     string    `json:"chat_id,omitempty"` // ID чата для отправки уведомления (MAX Messenger)
