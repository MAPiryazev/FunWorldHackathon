...
class ReminderHandler:
    ...
    async def handle_reminder_creation(self, user_id: str, nlp_data: dict) -> BotResponse:
        ...
        try:
            ...
            if result:
                ...
                complexity_emoji = format_complexity

                text = (
                    f"✅ Напоминание создано!\n\n"
                    f"Категория: {category_emoji}\n "
                    f"Текст: {nlp_data['text']}\n"
                    f"Дата/время: {time_info}\n"
    ...
    async def handle_time_request(self, user_id: str, text: str) -> BotResponse:
